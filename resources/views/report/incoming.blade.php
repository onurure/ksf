        ...
        <div class="widget-body">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <a class="btn btn-primary" href="{{url('incomereport')}}">Gelir-Alacak Raporu</a>
                    ...
                    <div class="carousel-wrap">
                        <div class="owl-carousel owl-theme">
                            @foreach ($firms as $firm)
                                <a class="{{$firm->id == request()->firm ? 'selected' : ''}} item link" href="{{ url('incomereport?firm='.$firm->id) }}"><img src="{{ url($firm->logo) }}"></a>
                            @endforeach
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <select class="js-select2 form-control" multiple="multiple" name="customers[]">
                                @foreach($customers as $customer)
                                    <option value="{{$customer->id}}" data-badge="">{{$customer->name}}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            <label for="email">Gelir - Alacak Tipi:</label>
                            <select class="js-select2 form-control" multiple="multiple" id="" name="geliralacak[]">
                                <option value="1">FATURA KESİLMESİ</option>
                                <option value="2">TAHSİLAT GİRİŞİ</option>
    ...
    <script>
        ...
        function ara(){
            ...
            "language": {
                ...
                "ordering": false,
                "ajax":{
                    url :"{{url('incomereport')}}", // json datasource
                    type: "post",
                    dataType: "json",
                    data: function(d) {
                        var o = {};
